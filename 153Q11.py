defprint('11\tWPP to enter principal amount, time and interst rate. create a compound_interest(principal,time,rate) function to calculate compound interest')
